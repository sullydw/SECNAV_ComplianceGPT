...
||**Next Phase:** `Phase L.22 LLM-Guided Intake User Interface Decision` — Decide whether the conversational builder should be exposed through CLI, TUI, web dashboard, or API; document the chosen path and create a lightweight plan; no renderer/layout/config/validator/catalog/command changes; error promotion unauthorized.
