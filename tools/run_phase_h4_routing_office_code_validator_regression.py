...
def main() -> int:
    ...
    allowed = {
        ...
        # Phase L.23 artifacts (Streamlit prototype)
        ...
        # Phase L.27A artifacts (Streamlit UI retirement)
        "app_streamlit_llm_guided_intake.py",
        "launch_secnav_streamlit.bat",
        "launch_secnav_streamlit.ps1",
        "launch_secnav_streamlit_ollama.bat",
        ...
        "tools/run_phase_l27a_retire_streamlit_ui_path_regression.py",
        "docs/checkpoints/phase_l27a_retire_streamlit_ui_path_checkpoint.md",
    }
